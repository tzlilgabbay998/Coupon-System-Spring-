...
public class CustomerService extends ClientService {
	...
	public String addPurchaseCoupon(Coupon coupon) throws CouponSystemException {
		Coupon couponToPurchase = couponRepo.findById(coupon.getId()).orElse(null);
		...
		} else if (couponRepo.existsByCustomersIdAndId(customerID, coupon.getId())) {
