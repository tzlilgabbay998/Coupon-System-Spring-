package couponSystemPhase3.TokensManager;
...
import couponSystemPhase3.TokensManager.JwtUtil.UserDetails;
import couponSystemPhase3.TokensManager.JwtUtil.UserDetails.UserType;
...
public class LoginController {
	...
	public String login(@RequestParam String userId, @RequestParam String userEmail, @RequestParam UserType userType,
		...
		switch (userType) {
		case ADMIN:
			if (!(userEmail.equals("admin@mail") && password.equals("admin"))) {
